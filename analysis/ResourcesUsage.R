...
specific_file_name="data/Cluster-10/variable.BLOCKCHAIN-100-sum.csv"
...
ggsave("BLOCKCHAIN-100Byz-full-replicas-idle-histogram.jpg")
...
ggsave("BLOCKCHAIN-100Byz-full-replicas-idle-points.jpg")