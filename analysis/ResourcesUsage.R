...
specific_file_name="data/Cluster-10/variable.HADOOP_BFT-30-sum.csv"
...
ggsave("HADOOP_BFTByz-full-replicas-idle-histogram.jpg")
...
ggsave("HADOOP_BFTByz-full-replicas-idle-points.jpg")